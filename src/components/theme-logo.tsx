...
export const ThemeLogo = ({ className = '', width = 24, height = 24 }: ThemeLogoProps) => {
  const combinedClassName = `text-foreground transition-colors duration-200 ${className}`.trim()
